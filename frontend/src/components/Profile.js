...
const Profile = () => {
  ...
  return (
    ...
    <div className="bg-white shadow-shadow-500 shadow-3xl rounded-primary relative mx-auto flex h-full w-full max-w-[350px] sm:max-w-[550px] flex-col items-center bg-cover bg-clip-border p-[16px] rounded" style={{marginTop:"100px", boxShadow:'0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)', minWidth:'350px'}}>
